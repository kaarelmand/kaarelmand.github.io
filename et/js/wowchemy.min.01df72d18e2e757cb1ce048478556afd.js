(() => {
  ...
  (() => {
    ...
    var e = {authors: "Authors", event: "Esinemised", post: "Blogi", project: "Projektid", publication: "Publikatsioonid", slides: "Slides"}, f = {no_results: "Tulemusi pole", placeholder: "Otsimine...", results: "tulemust"}, c = {indexURI: "/et/index.json", minLength: 1, threshold: 0.3}, d = {shouldSort: true, includeMatches: true, tokenize: true, threshold: c.threshold, location: 0, distance: 100, maxPatternLength: 32, minMatchCharLength: c.minLength, keys: [{name: "title", weight: 0.99}, {name: "summary", weight: 0.6}, {name: "authors", weight: 0.5}, {name: "content", weight: 0.2}, {name: "tags", weight: 0.5}, {name: "categories", weight: 0.5}]}, a = 60;
    function g(a2) {
