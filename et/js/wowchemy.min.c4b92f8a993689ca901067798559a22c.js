(() => {
  ...
  (() => {
    var content_type = {authors: "Authors", event: "Esinemised", post: "Blogi", project: "Projektid", publication: "Publikatsioonid", slides: "Slides"};
    var i18n = {no_results: "Tulemusi pole", placeholder: "Otsimine...", results: "tulemust"};
    var search_config = {indexURI: "/et/index.json", minLength: 1, threshold: 0.3};
